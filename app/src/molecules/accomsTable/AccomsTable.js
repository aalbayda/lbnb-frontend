        ...
        <Table striped hover>
                ...
                <thead>
                    <tr>
                        ...
                        <th><p className="small-bold">Type</p></th>
                        <th><p className="small-bold">Description</p></th>
                        <th><p className="small-bold">Location</p></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    {
                        ...
                        : accomBackend.accommodations.map((accom) => {
                            const {ACCOMMODATION_ID, ACCOMMODATION_NAME, ACCOMMODATION_TYPE, ACCOMMODATION_DESCRIPTION, ACCOMMODATION_LOCATION} = accom;
                            return <tr key={ACCOMMODATION_ID}>
